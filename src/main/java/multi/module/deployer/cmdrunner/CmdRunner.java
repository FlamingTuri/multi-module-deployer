...
public interface CmdRunner {
     ...
     * @return the reference to the process running the command
     */
     ...
     * @return the reference to the process that will run the command in a new detached terminal instance
     */
